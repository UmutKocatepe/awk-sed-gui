...
\[cite\_start]Bu proje, Linux sistemlerinde metin ve tablo tabanlı dosyaları düzenlemek için geliştirilmiş, \*\*Sed\*\* ve \*\*Awk\*\* komutlarının gücünü kullanıcı dostu arayüzlerle birleştiren bir araçtır\[cite: 3, 23]. \[cite\_start]PARDUS işletim sistemiyle tam uyumlu çalışacak şekilde tasarlanmıştır\[cite: 5].
...
\[cite\_start]Projenin çalışması için sisteminizde `yad` ve `whiptail` paketlerinin kurulu olması gerekmektedir\[cite: 8, 10].
